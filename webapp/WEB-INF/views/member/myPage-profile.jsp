                ...
                <form action="profile" method="POST" name="myPage-form" 
                    ...
                    <div class="profile-image-area">
                        ...
                        <c:if test="${empty loginMember.profileImage}">
                            <img src="${contextPath}/resources/images/user.png" id="profile-image" width="100" height="100">
                        </c:if>

                        <c:if test="${!empty loginMember.profileImage}">
                            <img src="${contextPath}${loginMember.profileImage}" id="profile-image" width="100" height="100">
                        </c:if>
